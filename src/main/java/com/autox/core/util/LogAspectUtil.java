...
public class LogAspectUtil {
   ...
   */
  @Pointcut("execution( * com.autox.core.service.GenericServiceImpl.*(..))" +
      " or execution( * com.autox.core.service.QdComputerServiceImpl.*(..))")
